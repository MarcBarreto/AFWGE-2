    ...
    def crossover(self, population, x, parents_idx, eval_population):
        ...
        for i in range(0, num_individuals, 2):
            if np.random.rand() <= self.pc and i + 1 < num_individuals:
                ...
                population = self.check_eval_offspring([parent1, parent2], [i, i + 1], population, x, eval_population)

        return population

    def mutate(self, population, x, parents_idx, eval_population):
        """
        ...
        population = self.check_eval_offspring(offsprings, parents_idx, population, x, eval_population)
